...
@Route(value = "supervisor_past_requests", layout = MainLayout.class)
@RolesAllowed("YAZILIM_YONETICISI")
@PageTitle("Geçmiş Talepler | Supervisor")
public class Software_SPastRequests extends VerticalLayout {
    ...
    public Software_SPastRequests(RequestService requestService, RequestNoteService requestNoteService, UserService userService, org.vaadin.example.domain.priority.service.PriorityCalculationService priorityCalculationService) {
        ...
        requestGrid.addColumn(req -> {
            ...
            return p != null && p.getSoftwareMgrScore() != null ? p.getSoftwareMgrScore().toString() : "-";
    ...
    private void updateGrid() {
        requestGrid.setItems(requestService.findPastForSupervisor());
    }
    ...
    private void openDetailsDialog(Request reqArg) {
        ...
        if (req.getStatus() == org.vaadin.example.shared.enums.RequestStatus.REJECTED || req.getStatus() == org.vaadin.example.shared.enums.RequestStatus.UNASSIGNED) {
            ...
            com.vaadin.flow.component.textfield.IntegerField softwareMgrScoreField = new com.vaadin.flow.component.textfield.IntegerField("Software Manager Score (1-5)");
            softwareMgrScoreField.setMin(1);
            softwareMgrScoreField.setMax(5);
            softwareMgrScoreField.setValue(p != null ? p.getSoftwareMgrScore() : null);

            scoringArea.add(new H3("Yeniden Puanlama"), softwareMgrScoreField);
